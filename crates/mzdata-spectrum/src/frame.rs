...
use crate::scan_properties::SCAN_TITLE;
use crate::{
    Acquisition, MultiLayerSpectrum, Precursor,
    RawSpectrum, ScanPolarity, SignalContinuity, SpectrumConversionError, SpectrumDescription,
};
use mzdata_bindata::{
    ArrayRetrievalError, ArrayType, ArraysAvailable, BinaryArrayMap, BinaryArrayMap3D,
    BuildArrayMap3DFrom,
    BuildFromArrayMap,
    BuildFromArrayMap3D,
    ByteArrayViewMut,
...
use mzdata_param::{
    Param, ParamDescribed, ParamList, ParamValue, Unit, impl_param_described,
};
...
mod mzsignal_impl {
    ...
    use mzsignal::{
        PeakFitType,
        feature_mapping::{FeatureExtracterType, MapState, PeakMapState},
