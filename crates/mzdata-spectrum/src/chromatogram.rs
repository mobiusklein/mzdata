...
use mzdata_bindata::{ArrayRetrievalError, ArrayType, BinaryArrayMap, ByteArrayView};
use mzdata_param::{Param, ParamDescribed};
use crate::scan_properties::{
    ChromatogramDescription, ChromatogramType, Precursor, ScanPolarity, Product
};
...
impl ParamDescribed for Chromatogram {
    ...
    fn params_mut(&mut self) -> &mut mzdata_param::ParamList {
