...
>: ParamDescribed
{
    ...
    fn spectrum_type(&self) -> Option<mzdata_meta::SpectrumType> {
        self.description().spectrum_type()
    }

    /// Set the kind of spectrum represented.
    fn set_spectrum_type(&mut self, spectrum_type: mzdata_meta::SpectrumType) {
