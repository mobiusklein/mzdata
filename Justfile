...
docs:
    cargo doc --no-deps --features nalgebra,parallelism,mzsignal,zlib-ng-compat,thermo,async,proxi,bruker_tdf,imzml,cv -p mzdata -p mzsignal -p mzpeaks -p mzdata-param
