...
quick-docs:
    cargo doc --no-deps -p mzdata --features doc-images

docs:
    cargo doc --no-deps --features nalgebra,parallelism,mzsignal,mzmlb,zlib-ng-compat,thermo,async,doc-images -p mzdata
